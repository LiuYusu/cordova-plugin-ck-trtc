package org.apache.cordova.trtc.videocall;
...
import org.apache.cordova.trtc.basic.TRTCBaseActivity;
...
public class VideoCallingActivity extends TRTCBaseActivity implements View.OnClickListener {
  ...
  private void initView() {
    mTextTitle = (TextView) findViewById(R.id.tv_room_number);
    mImageBack = (ImageView) findViewById(R.id.iv_back);
    mTXCVVLocalPreviewView = (TXCloudVideoView) findViewById(R.id.txcvv_main);
    mButtonMuteVideo = (ImageView) findViewById(R.id.btn_mute_video);
    mButtonMuteAudio = (ImageView) findViewById(R.id.btn_mute_audio);
    mButtonSwitchCamera = (ImageView) findViewById(R.id.btn_switch_camera);
    mButtonAudioRoute = (ImageView) findViewById(R.id.btn_audio_route);
  ...
  private void showReturnAlert() {
    AlertDialog.Builder normalDialog = new AlertDialog.Builder(VideoCallingActivity.this);
    normalDialog.setTitle("提示");
    normalDialog.setMessage("退出后将无法再次进入此次会议，确定退出吗?");
  ...
  private void muteVideo() {
    ...
    if (!isSelected) {
      mTRTCCloud.stopLocalPreview();
      toast = Toast.makeText(VideoCallingActivity.this, "摄像头已关闭", Toast.LENGTH_SHORT);
      mButtonMuteVideo.setImageResource(R.drawable.trtcmeeting_ic_meeting_camera_off);
    } else {
      mTRTCCloud.startLocalPreview(mIsFrontCamera, mTXCVVLocalPreviewView);
      toast = Toast.makeText(VideoCallingActivity.this, "摄像头已打开", Toast.LENGTH_SHORT);
      mButtonMuteVideo.setImageResource(R.drawable.trtcmeeting_ic_meeting_camera_on);
    }
    toast.show();
  ...
  private void muteAudio() {
    ...
    if (!isSelected) {
      ...
      toast = Toast.makeText(VideoCallingActivity.this, "麦克风已关闭", Toast.LENGTH_SHORT);
      toast.show();
      mButtonMuteAudio.setImageResource(R.drawable.trtcmeeting_ic_meeting_mic_off);
    } else {
      mTRTCCloud.muteLocalAudio(false);
      toast = Toast.makeText(VideoCallingActivity.this, "麦克风已打开", Toast.LENGTH_SHORT);
      mButtonMuteAudio.setImageResource(R.drawable.trtcmeeting_ic_meeting_mic_on);
    }
    toast.show();
  ...
  private void switchCamera() {
    ...
    if (mIsFrontCamera) {
      toast = Toast.makeText(VideoCallingActivity.this, "正在使用前置摄像头", Toast.LENGTH_SHORT);
    } else {
      toast = Toast.makeText(VideoCallingActivity.this, "正在使用后置摄像头", Toast.LENGTH_SHORT);
    }
    toast.show();
  }
  ...
  private void audioRoute() {
    ...
    if (mAudioRouteFlag) {
      ...
      toast = Toast.makeText(VideoCallingActivity.this, "正在使用听筒", Toast.LENGTH_SHORT);
      mButtonAudioRoute.setImageResource(R.drawable.ic_meeting_headset);
    } else {
      mAudioRouteFlag = true;
      mTXDeviceManager.setAudioRoute(TXDeviceManager.TXAudioRoute.TXAudioRouteSpeakerphone);
      toast = Toast.makeText(VideoCallingActivity.this, "正在使用扬声器", Toast.LENGTH_SHORT);
      mButtonAudioRoute.setImageResource(R.drawable.ic_meeting_speaker);
    }
    toast.show();
  }
